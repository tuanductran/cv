...
<template>
   <figcaption class="mt-3 md:mt-0 z-10">
      ...
      <!-- End Client title -->
      <p>
         <a class="text-xs lg:text-base text-main-color rounded-full" v-for="link, k in client.links" :href="link" :key="k" target="_blank" onClick="ga('event', 'ClientLink', 'view', 'client_link');">
            <strong>{{ link }}</strong>
         </a>
      </p>
      <!-- Client descript -->
