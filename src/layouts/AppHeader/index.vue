...
<template>
   <nav class="fixed z-20 top-0 left-0 right-0 bg-white py-3 lg:py-4 shadow-sm">
      <div class="flex items-center container mx-auto px-5 md:px-9 lg:px-16 xl:px-36 2xl:px-52">
         ...
         <!-- End three bars menu -->
         <!-- Navbar menu -->
      	<ul class="bg-white bg-navbar transition-transform absolute md:relative top-0 left-0 h-screen md:h-auto w-3/4 md:w-auto p-5 md:p-0 md:flex md:bg-transparent md:transform-none items-center mr-auto vnodesign-border-navbar" :class="{ 'transform -translate-x-full': isCollapsed }">
            <!-- Menu links -->
